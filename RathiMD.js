...
const { XeonBotIncTiktok } = require('./lib/rathitkitok')
let { msgFilter } = require('./lib/antispam')
let { covid } = require('./lib/covid.js') 
const { EmojiAPI } = require("emoji-api")
const emoji = new EmojiAPI()
const thiccysapi = require('textmaker-thiccy')
const { XeonBotIncWiki } = require('./lib/wikibyrathi.js')
...
//Database omther\\
let xeonysticker = JSON.parse(fs.readFileSync('./RATHI/Media-Store/sticker.json'));
let xeonyaudio = JSON.parse(fs.readFileSync('./RATHI/Media-Store/audio.json'));
let xeonyimage = JSON.parse(fs.readFileSync('./RATHI/Media-Store/image.json'));
let xeonyvideo = JSON.parse(fs.readFileSync('./RATHI/Media-Store/video.json'));
let autosticker = JSON.parse(fs.readFileSync('./database/autosticker.json'));
const _autostick = JSON.parse(fs.readFileSync('./database/autostickpc.json'));
let banUser = JSON.parse(fs.readFileSync('./database/banUser.json'));
let banchat = JSON.parse(fs.readFileSync('./database/banChat.json'));
let bad = JSON.parse(fs.readFileSync('./RATHI/sc/bad.json'))
...
if (!('templateVideo' in setting)) setting.templateVideo = false
	...
	// FAKE TEXT IMG
const textImg = (teks) => {
XeonBotInc.sendMessage(m.chat, { text :teks, }, {quoted: m, thumbnail: fs.readFileSync('./RATHI/pic/wpmobile.png')}) 
}
...
"ptt": "true"
	...
	//group target \\
const reply = (teks) => {
           XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./RATHI/pic/rathi.jpg`),"sourceUrl": `${linkz}`}}}, { quoted: m})
        }
...
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
  ...
  //if (Autoreply) //remove forwad slashes to make it autoreply on off
        for (let anji of xeonysticker){
				if (budy === anji){
					result = fs.readFileSync(`./XeonMedia/sticker/${anji}.webp`)//////////////////////////මේක තියේ
			...
			for (let anju of xeonyaudio){
				if (budy === anju){
					result = fs.readFileSync(`./XeonMedia/audio/${anju}.mp3`)//////////////////////////මේක තියේ
			...
			for (let anjh of xeonyimage){
				if (budy === anjh){
					result = fs.readFileSync(`./XeonMedia/image/${anjh}.jpg`)//////////////////////////මේක තියේ
			  ...
			  //if (Autoreply) //remove forwad slashes to make it autoreply on off
				...
				if (budy === anjh){
					result = fs.readFileSync(`./XeonMedia/video/${anjh}.mp4`)//////////////////////////මේක තියේ
...
if (!m.isGroup) return
if (m.key.fromMe) return
sendNye = fs.readFileSync('./RATHI/stickers/rathitag.webp')
